...
class PiCO(nn.Module):
    ...
    def __init__(self, args, base_encoder):
        ...
        self.encoder_q = base_encoder(args, num_class=args.num_classes, feat_dim=args.low_dim, name=args.arch,
                                      pretrained=pretrained)
        # momentum encoder
        self.encoder_k = base_encoder(args, num_class=args.num_classes, feat_dim=args.low_dim, name=args.arch,
                                      pretrained=pretrained)
        ...
        self.register_buffer("queue_pseudo", torch.randn(args.moco_queue, args.num_classes))
        self.register_buffer("queue_partial", torch.randn(args.moco_queue, args.num_classes))
    ...
    def forward(self, img_q, im_k=None, partial_Y=None, args=None, eval_only=False):
        ...
        for feat, label, max_score in zip(concat_all_gather(q), concat_all_gather(pseudo_labels),
                                          concat_all_gather(max_scores)):
